...
function App() {
  ...
  return (
    <div className="bg-red-300 min-h-screen flex flex-col items-center mx-auto">
      <br />
      <br />
      <br />
      <select value={selectedCity} onChange={handleSelect} className="select w-full max-w-xs">
        {cities.map((x, index) => (
